...
// --- Assets ---
import music from "../public/bg.mp3";       // Background music
  ...
  return (
    ...
    >
      ...
      <Sequence durationInFrames={32}>
        <SceneTitle
          title="Understanding React DOM"
          subtitle="Explained by Jace Morales"
          image={icon}
        />
      </Sequence>

      {/* --- Scene 1: What is the DOM --- */}
...
ReactDOM.render(
  ...
  document.getElementById("root")
      ...
      <Sequence from={1355} durationInFrames={132}>
        <SceneTitle
          title="React DOM bridges React and the Browser"
          subtitle="That’s the power of React!"
          image={icon}
        />
      </Sequence>
    </AbsoluteFill>
